"""ILPF y GLPF sobre TEXTO.BMP usando el compositor Grafica."""
...
def main(
    ruta: Path = DATA_DIR / "TEXTO.BMP",
    corte_ideal: float = 30,
    corte_gaussiano: float = 10,
) -> None:
    ...
    grafica = Grafica(
        "TEXTO.BMP · Filtrado pasabajas en Fourier",
        columnas=5,
        ancho_panel=3.4,
        alto_panel=3.2,
    )
