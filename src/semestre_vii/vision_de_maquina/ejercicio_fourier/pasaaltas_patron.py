"""Filtros IHPF, GHPF y BHPF sobre el patrón exacto mostrado en clase."""
...
def main(d0: float = 30, orden_butterworth: int = 1, fila: int | None = None) -> None:
    ...
    (
        Grafica(f"Fourier · filtros pasaaltas · patrón de clase · D0={d0:g}", columnas=3)
        .imagen(imagen, "IMG profesor")
